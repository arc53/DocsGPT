...
class TavilySearchTool(Tool):
    ...
    def __init__(self, config):
        self.config = config
        self.api_key = config.get("token", "") or os.getenv("TAVILY_API_KEY", "")
    ...
    def get_actions_metadata(self):
        return [
            ...
            },
            {
                ...
                "description": "Search for recent news articles using Tavily. Returns titles, URLs, and content snippets.",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "query": {
