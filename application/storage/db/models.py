...
agents_table = Table(
    ...
    Column("guardrails_enabled", Boolean, nullable=False, server_default="false"),
    Column("input_guardrails", Boolean, nullable=False, server_default="false"),
    Column("output_guardrails", Boolean, nullable=False, server_default="false"),
