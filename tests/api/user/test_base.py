...
class TestTimeRangeGenerators:
    ...
    def test_generate_minute_range(self):
        from docsgpt.api.user.base import generate_minute_range
    ...
    def test_generate_hourly_range(self):
        from docsgpt.api.user.base import generate_hourly_range
    ...
    def test_generate_date_range(self):
        from docsgpt.api.user.base import generate_date_range
...
class TestGetVectorStore:
    ...
    @patch("docsgpt.api.user.base.VectorCreator.create_vectorstore")
...
class TestHandleImageUpload:
    ...
    def test_returns_existing_url_when_no_file(self, flask_app):
        from docsgpt.api.user.base import handle_image_upload
    ...
    def test_accepts_image_at_encoded_byte_limit(self, flask_app):
        ...
        with patch(
            "docsgpt.api.user.base.settings.AGENT_IMAGE_MAX_BYTES",
            len(payload),
    ...
    def test_enforces_decoded_pixel_limit(
        ...
        with patch(
            "docsgpt.api.user.base.settings.AGENT_IMAGE_MAX_PIXELS", 16
        ), flask_app.app_context():
            mock_file = FileStorage(
