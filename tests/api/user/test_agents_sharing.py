"""Tests for docsgpt.api.user.agents.sharing module."""
...
class TestSharedAgent:
    ...
    def test_returns_404_agent_not_found(self, app):
        ...
        with patch(
            "docsgpt.api.user.agents.sharing.agents_collection", mock_col
        ):
    ...
    def test_returns_shared_agent_data(self, app):
        ...
        with patch(
            "docsgpt.api.user.agents.sharing.agents_collection", mock_agents_col
        ), patch(
            "docsgpt.api.user.agents.sharing.resolve_tool_details", mock_resolve
        ), patch(
            "docsgpt.api.user.agents.sharing.db", mock_db
        ):
            with app.test_request_context("/api/shared_agent?token=abc123"):
    ...
    def test_adds_to_shared_with_me_for_different_user(self, app):
        ...
        with patch(
            ...
            "docsgpt.api.user.agents.sharing.ensure_user_doc", mock_ensure
        ), patch(
            "docsgpt.api.user.agents.sharing.users_collection", mock_users_col
        ):
            with app.test_request_context("/api/shared_agent?token=abc123"):
                from flask import request
    ...
    def test_enriches_tool_names(self, app):
        ...
        with patch(
            ...
            "docsgpt.api.user.agents.sharing.user_tools_collection", mock_tools_col
        ), patch(
            "docsgpt.api.user.agents.sharing.resolve_tool_details", mock_resolve
        ), patch(
            "docsgpt.api.user.agents.sharing.db", mock_db
    ...
    def test_image_url_generated_when_present(self, app):
        ...
        with patch(
            ...
            "docsgpt.api.user.agents.sharing.generate_image_url", mock_generate
        ):
            with app.test_request_context("/api/shared_agent?token=tok"):
                from flask import request
...
class TestSharedAgents:
    ...
    def test_image_url_generated(self, app):
        ...
        with patch(
            ...
            "docsgpt.api.user.agents.sharing.users_collection", Mock()
        ):
            with app.test_request_context("/api/shared_agents"):
                from flask import request
