...
export default function Conversation() {
  ...
  return (
    <div className="flex flex-col gap-1 h-full justify-end">
      ...
      <div className="flex w-[80%] sm:w-[90%] md:w-[80%] flex-col items-end self-center rounded-2xl bg-opacity-0 pb-1 h-auto">
        ...
        <p className="text-gray-595959 my-3 sm:my-5 self-center bg-transparent py-2 text-center text-xs dark:text-bright-gray md:inline md:w-full">
          {t('tagline')}
        </p>
      </div>
    </div>
