  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      ...
      size: {
        ...
        field: 'h-10.5 px-4 has-[>svg]:px-3',
        icon: 'size-9',
        'icon-xs': 'size-7',
        'icon-sm': 'size-8',
        'icon-lg': 'size-10',
    ...
    compoundVariants: [
      ...
      { shape: 'pill', size: 'default', class: 'px-5 has-[>svg]:px-4' },
      { shape: 'pill', size: 'lg', class: 'px-6 has-[>svg]:px-5' },
      // Text starts 21px in, like the Input and SelectTrigger pills beside it.
      { shape: 'pill', size: 'field', class: 'px-5 has-[>svg]:px-4' },
      ...
      // Nav rows line their icons up on the left edge at every size/shape.
      {
        ...
        class:
          'justify-start gap-2.5 rounded-full pr-0 pl-3 font-normal has-[>svg]:pr-0 has-[>svg]:pl-3',
      },
    ],
    defaultVariants: {
      variant: 'default',
