...
function WorkflowBuilderInner() {
  ...
  return (
    <div className="bg-lotion dark:bg-outer-space flex h-screen w-full flex-col">
      <div className="border-light-silver flex items-center justify-between border-b bg-white px-6 py-4 dark:border-[#3A3A3A] dark:bg-[#2C2C2C]">
          ...
          <div className="relative">
            ...
            {showWorkflowSettings && (
              <div
                ...
                className="absolute top-full left-0 z-50 mt-2 w-80 rounded-xl border border-[#E5E5E5] bg-white p-4 shadow-lg dark:border-[#3A3A3A] dark:bg-[#2C2C2C]"
              >
                <div className="mb-3">
                  ...
                  <input
                    ...
                    className="focus:ring-purple-30 w-full rounded-lg border border-[#E5E5E5] bg-white px-3 py-2 text-sm outline-none focus:ring-2 dark:border-[#3A3A3A] dark:bg-[#383838] dark:text-white"
        ...
        <div className="flex items-center gap-3">
          <button className="flex items-center gap-2 rounded-full border border-gray-200 bg-white px-4 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50 dark:border-[#3A3A3A] dark:bg-[#2C2C2C] dark:text-gray-200 dark:hover:bg-[#383838]">
            <Play size={16} />
            Preview
          </button>
          <button
      ...
      {publishErrors.length > 0 && (
        <div className="pointer-events-none absolute top-20 right-0 left-64 z-50 flex justify-center px-4">
          ...
          >
            ...
            <AlertTitle>Unable to publish workflow</AlertTitle>
            <AlertDescription>
      ...
      <div className="flex flex-1 overflow-hidden">
        <div className="border-light-silver flex w-64 flex-col gap-6 border-r bg-gray-50 p-4 dark:border-[#3A3A3A] dark:bg-[#2C2C2C]">
          <div>
            ...
            <div className="flex flex-col gap-2">
              <div
                className="group flex cursor-move items-center gap-3 rounded-full border bg-white px-4 py-3 shadow-sm transition-all hover:shadow-md dark:border-[#3A3A3A] dark:bg-[#383838] dark:hover:bg-[#383838]"
                draggable
                onDragStart={(e) =>
        ...
        <div className="dark:bg-outer-space relative flex-1 bg-gray-50">
          <ReactFlow
            nodes={nodes}
            edges={edges}
          ...
          {showNodeConfig && selectedNode && (
            <div
              ref={configPanelRef}
              className="border-light-silver absolute top-4 right-4 w-96 rounded-2xl border bg-white shadow-[0px_4px_40px_-3px_#0000001A] dark:border-[#3A3A3A] dark:bg-[#2C2C2C]"
            >
              ...
              <div className="max-h-[calc(100vh-200px)] overflow-y-auto p-4">
                <div className="mb-4 flex flex-col gap-2">
                  <div className="rounded-lg bg-gray-50 p-3 dark:bg-[#383838]">
