...
# ``from docsgpt.core.model_settings import ModelRegistry`` keep
# working. The implementation lives in ``docsgpt/core/model_registry.py``.
...
def __getattr__(name):
    ...
    if name == "ModelRegistry":
        from docsgpt.core.model_registry import ModelRegistry as _MR
