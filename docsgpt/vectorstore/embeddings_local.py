...
Models are described in :mod:`docsgpt.vectorstore.model_registry`. A name
...
from docsgpt.vectorstore.model_registry import EmbeddingModel, resolve, known_names
