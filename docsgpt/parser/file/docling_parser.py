...
from docsgpt.parser.file.ocr_parser import VALID_OCR_ENGINES as _VALID_OCR_ENGINES
from docsgpt.parser.file.ocr_parser import collapse_cjk_spaces
...
def _resolve_ocr_engine(requested: Optional[str]) -> str:
    ...
    """
    from docsgpt.core.settings import settings
    from docsgpt.parser.file.base_parser import module_available
...
def _build_ocr_options(
    ...
    try:
        if engine == "tesseract":
            ...
            from docsgpt.parser.file.ocr_parser import tesseract_languages
