...
Usage::
    ...
    python -m docsgpt.scripts.reembed --dry-run     # report, change nothing
    python -m docsgpt.scripts.reembed               # re-embed everything
    python -m docsgpt.scripts.reembed --sources a,b # only these sources
"""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="python -m docsgpt.scripts.reembed",
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    # than the environment -- ``docsgpt.app`` resolves it at boot, and this
    ...
    from docsgpt.storage.db.embeddings_pin import resolve_embeddings_pin
